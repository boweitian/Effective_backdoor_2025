...
class Metric ():
	...
	def calculateSSIM(self, gt, predict):
		...
		ssim_img1 = gt.transpose(1, 2, 0)
		ssim_img2 = predict.transpose(1, 2, 0) # (32,32,3)
		range_d = ssim_img1.max() - ssim_img1.min()
		return metrics.structural_similarity(ssim_img1, ssim_img2, multichannel=True,win_size=3,data_range=range_d)
